...
export const FeaturedItem = ({ item, height = '160' }: IProps) => {

    return (
        <div className={`h-${height} relative rounded-md overflow-hidden w-full flex items-center justify-center cursor-pointer shadow-lg`}>
